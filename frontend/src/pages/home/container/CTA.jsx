            ...
            <div className='container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center '>
                <div className='col-span-12 mt-20 lg:col-span-6 '>
                    ...
                    <p className='text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left '>
                        <span className='font-bold italic text-[#B3BAC5] md:not-italic md:font-normal md:text-dark-light'>Get a response tomorrow</span> if you submit by 9pm today. If we received after 9pm will get a response the following day
                    </p>
                </div>
                <div className='col-span-12 hidden mt-[70px] md:block md:order-first lg:col-span-6 lg:order-last'>
                    <div className='w-3/4 mx-auto relative'>
                        ...
                        <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                            <img src={images.cta} alt="Articles"  className='w-full object-cover object-center h-auto md:h-52 lg:h-48 xl:h-60'/>
                            <div className='p-5'>
