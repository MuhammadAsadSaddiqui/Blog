        ...
        <section className = "container mx-auto px-5 py-10">
            <div className='w-full max-w-sm mx-auto'>
                ...
                <form onSubmit={handleSubmit(submitHandler)}>
                    ...
                    className='bg-primary text-white font-bold text-lg py-4 px-8 w-full rounded-lg my-6 disabled:opacity-70 disabled:cursor-not-allowed disabled:bg-gray-500'>
                        Sign in
                    </button>
